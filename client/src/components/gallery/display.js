        ...
        <SectionNarrow>
            <Layout>
                ...
                <Image1 onClick={() => setFull(imgl1)}>
                    <img
                        src={imgl1}
                        alt="foto auto spuiten en carrosseriewerk"
                    />
                </Image1>
                <P2>{p2}</P2>
            ...
            {full && (
                <Full>
                    <SocialButton onClick={() => setFull(null)}>
                        <MdClose />
                    </SocialButton>
                    <img
                        src={full}
